...
- Tab `ตั้งค่างาน` ต้องมี vertical scroll เฉพาะ settings content/sub-tabs เพื่อรองรับจอเตี้ยและ Windows display scaling โดยไม่ดัน Preview/Queue ออกจากหน้าจอ

...
วันที่ทดสอบ: 2026-09-06 10:32 +07:00
...
หมายเหตุ slice ล่าสุด: การปรับ Batch Workspace เป็น tab ชั้นนอก `ตั้งค่างาน` / `Queue Monitor`, การจำกัด Search occurrence range slider เป็น 0-100, และการทำให้ Preview canvas ใหญ่ขึ้นพร้อม resizable splitters เป็น source-only UI refactor
...
| Coverage gate | configured in `pyproject.toml` | Passed: 79.43% >= 75% |

...
- แท็บ `ออกแบบลายน้ำ`: ดู Preview, เพิ่ม/แก้ไข Text และ Logo และลากเส้นแบ่งเพื่อปรับ panel
- แท็บ `ไฟล์และการประมวลผล`: ตั้งค่าต้นทาง/ปลายทางและตรวจคิว ก่อนกดเริ่ม
- แท็บ `ผลลัพธ์`: เปิดไฟล์ที่เสร็จ ดูข้อผิดพลาด หรือลองใหม่เฉพาะไฟล์ที่ล้มเหลว
- Progress ในคิวเป็นแถบพร้อมตัวเลขตามงานจริง หลังงานจบระบบจะคืนปุ่มพร้อมรับรอบถัดไปเมื่อ thread ปิดครบ โดยไม่ต้องล้างการตั้งค่า
